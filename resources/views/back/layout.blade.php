...
<div class="wrapper">
     ...
     <aside class="main-sidebar">
        <section class="sidebar">
            <ul class="sidebar-menu">
                ...
                <li class="header" style="font-size: 15px;"><i class="fa fa-arrow-down" aria-hidden="true"></i> Admin Panel <i class="fa fa-arrow-down" aria-hidden="true"></i></li>
                <li>
                ...
                <li>
                    <a href="{{ route('admin-gallery')}}">
                        <i class="fa fa-picture-o"></i> <span>Galleriya | Gallery</span>
                    </a>
                </li>
                <li>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2020 <a href="#">190-MTT</a>.</strong> All rights reserved.
    </footer>
